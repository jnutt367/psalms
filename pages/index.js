...
<main className={styles.main}>
    ...
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/GK4eM8DIrFs?si=0X5lEdvIlbDtjVnH?autoplay=1&mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>                      
 ...
 <p>Next</p>                                  
           <Image className={styles.arrow}
                              ...
                              />
                                  ...
                                  <div className={styles.iframe}> 
<iframe width="100%" height="300" src="https://www.youtube.com/embed/dpny22k_7uk?autoplay=1&mute=1" title="YouTube video player" frameborder="2" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>                   
                   ...
                   <div className={styles.card}>
                     ...
                     <div className={styles.card}>
                              ...
                              <h2 className={styles.chapter}>PSALM 27</h2>
                                    ...
                                    <div id="twentyeight" className={styles.card}>
                              ...
                              <h2 className={styles.chapter}>PSALM 94</h2>
                                      <p>
                                       The Lord is a God who avenges.
                                                 1 O God who avenges, shine forth.
                              ...
                              <h2 className={styles.chapter}>PSALM 95</h2>
                                      <p>
                                       Come, let us sing for joy to the Lord;
                                                      1 let us shout aloud to the Rock of our salvation.
                              ...
                              <h2 className={styles.chapter}>PSALM 105</h2>
                                      <p>
                                       Give praise to the Lord, proclaim his name;
                                                         1 make known among the nations what he has done.
                              ...
                              <h2 className={styles.chapter}>PSALM 113</h2>
                                      <p>
                                       Praise the Lord.
                                                ...
                                                1 Praise the Lord, you his servants;
                              ...
                              <h2 className={styles.chapter}>PSALM 147</h2>
                                      <p>
                                       Praise the Lord.
                                                  ...
                                                  1 How good it is to sing praises to our God,
